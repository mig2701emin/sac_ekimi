                                            ...
                                            <div class="moto-widget moto-widget-row__column moto-cell col-sm-3 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                                                <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
                                                    <div class="moto-widget-text-content moto-widget-text-editable">
                                                      <p class="moto-text_system_1"><a data-action="page" data-id="1" class="moto-link" href="/">CLEAR SKIN</a></p>
                                                      <p class="moto-text_system_2"><a data-action="page" data-id="1" class="moto-link" href="/">DERMATOLOGY CLINIC</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div data-widget-id="wid__menu__5b1651165e644" class="moto-widget moto-widget-menu moto-preset-3 moto-align-right moto-align-center_mobile-h moto-spacing-top-small moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-preset="3" data-widget="menu">
                                                    ...
                                                    <ul class="moto-widget-menu-list moto-widget-menu-list_horizontal">
                                                        <li class="moto-widget-menu-item moto-widget-menu-item-has-submenu">
                                                            <a href="/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-widget-menu-link-submenu moto-link">ANASAYFA<span class="fa moto-widget-menu-link-arrow"></span></a>
                                                            <ul class="moto-widget-menu-sublist">
                                                                <li class="moto-widget-menu-item">
                                                                    <a href="/about-us/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-link">İletişim</a>
                                                                </li>
                                                                <li class="moto-widget-menu-item moto-widget-menu-item-has-submenu">
                                                                    ...
                                                                    <ul class="moto-widget-menu-sublist">
                                                                        <li class="moto-widget-menu-item">
                                                                            <a href="/contacts/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-3 moto-link">İLETİŞİM</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                <li class="moto-widget-menu-item">
                                                                    <a href="/gallery/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-2 moto-link">GALERİ</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/services/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">HİZMETLER</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/doctors/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">DOKTORLAR</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/products/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">PRODUCTS</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/testimonial/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">REFERANSLAR</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/gallery/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">GALERİ</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/make-an-appointment/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">RANDEVU</a>
                                                        </li>
                                                        <li class="moto-widget-menu-item">
                                                            <a href="/contacts/" data-action="page" class="moto-widget-menu-link moto-widget-menu-link-level-1 moto-link">İLETİŞİM</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" data-container="container">
                                        <div class="moto-widget moto-widget-row__column moto-cell col-sm-12 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa" data-bg-position="left top">
                                            <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aasa" data-animation="">
                                                <div class="moto-widget-text-content moto-widget-text-editable">
                                                  <p class="moto-text_system_4">Blog</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="moto-cell col-sm-12" data-container="container">
                                                                            ...
                                                                            <div class="moto-blog-post-content moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto">
                                                                                <p class="moto-text_normal">The modern market is absolutely unpredictable. And yet it lives according to strict laws. The marketers need to be known to achieve maximum results in their business - that is the main task of the marketer.</p>
                                                                            </div>
                                                                ...
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="moto-cell col-sm-12" data-container="container">
                                                                            ...
                                                                            <div class="moto-blog-post-content moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-small moto-spacing-left-auto">
                                                                                <p class="moto-text_normal">Media prices are falling, so advertising becomes more profitable. The combination of low prices on media and weak competition gives companies the opportunity to cheaply grab market share.</p>
                                                                            </div>
                                ...
                                <div class="row" data-container="container">
                                    <div class="moto-widget moto-widget-row__column moto-cell col-sm-3 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa">
                                        <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-medium moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aama" data-animation="">
                                            <div class="moto-widget-text-content moto-widget-text-editable">
                                              <p class="moto-text_system_1"><a data-action="page" data-id="1" class="moto-link" href="/">CLEAR SKIN</a></p>
                                              <p class="moto-text_system_2"><a href="/" data-action="page" data-id="1" class="moto-link"><span class="moto-color5_5">DERMATOLOJİ KLİNİĞİ</span></a></p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row" data-container="container">
                                                    <div class="moto-widget moto-widget-row__column moto-cell col-xs-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa">
                                                        <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
                                                            <div class="moto-widget-text-content moto-widget-text-editable">
                                                              <p class="moto-text_202"><a href="/about-us/" data-action="page" data-id="10" class="moto-link">Hakkımızda</a></p>
                                                              <p class="moto-text_202"><a href="/services/" data-action="page" data-id="13" class="moto-link">HİZMETLER</a></p>
                                                              <p class="moto-text_202"><a href="/doctors/" data-action="page" data-id="12" class="moto-link">DOKTORLAR</a></p>
                                                              <p class="moto-text_202"><a href="/products/" data-action="page" data-id="14" class="moto-link">Products</a></p>
                                                              <p class="moto-text_202"><a href="/testimonial/" data-action="page" data-id="17" class="moto-link">Referanslarımız</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="moto-widget moto-widget-row__column moto-cell col-xs-6 moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" style="" data-widget="row.column" data-container="container" data-spacing="aaaa">
                                                        <div class="moto-widget moto-widget-text moto-preset-default moto-spacing-top-auto moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto" data-widget="text" data-preset="default" data-spacing="aaaa" data-animation="">
                                                            <div class="moto-widget-text-content moto-widget-text-editable">
                                                              <p class="moto-text_202"><a href="/gallery/" data-action="page" data-id="15" class="moto-link">GALERİ</a></p>
                                                              <p class="moto-text_202"><a href="/make-an-appointment/" data-action="page" data-id="18" class="moto-link">RANDEVU</a></p>
                                                              <p class="moto-text_202"><a href="/blog/" data-action="blog.index" data-id="3" class="moto-link">Haberler</a></p>
                                                              <p class="moto-text_202"><a href="/contacts/" data-action="page" data-id="16" class="moto-link">İletişim</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
